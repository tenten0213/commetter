...
Two middleware functions are provided by default in the `commetter.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `commetter.handler` namespace to manage the enabled middleware.
